...
public interface VehicleInterface {
	...
	/**
	 * Sends the bus to the closest station to fuel up. The method uses the simplest
	 * possible route, disregarding passengers.
	 */
	public void visitClosestStationFuelUp() throws InterruptedException, ApiException, IOException;

	/**
	 * Sets the bus's intended route to the specified DirectionsRoute-object. Used
	 * mostly to move the bus to the wanted route before actual passenger-servicing
	 * begins.
	 * 
	 * @param route specifies the DirectionsRoute-object the vehicle's intended route
	 *            to be set to
	 */
	public void setIntendedRoute(DirectionsRoute route);

	/**
	 * Returns a list of DirectionsSteps representing the currentRoute-variable of
	 * the bus.
	 * 
	 * @return returns the LatLng-object representing the current location of the
	 *         passenger.
	 */
	public List<DirectionsStep> getRoute();

	/**
	 * Returns the maximum amount of passengers the vehicle can take at any one
	 * time.
	 * 
	 * @return returns the int-value representing the maximum amount of passengers
	 *         for the vehicle
	 */
	public int getMaxPassengers();

	/**
	 * Returns a list of PassengerInterface-objects representing the passengers
	 * currently on-board.
	 * 
	 * @return returns a list of PassengerInterface-objects representing the
	 *         passengers currently on-board
	 */
	public List<PassengerInterface> getPassengersOnBoard();

	/**
	 * Returns the id of the vehicle. Id is used for a multitude of different
	 * operations.
	 * 
	...
	/**
	 * Set boolean value whether to keep routing and driving the vehicle after
	...
	/**
	 * Set the vehicle to drive the intended route. Requires route to be set up
	 * beforehand.
	 */
	void driveRoute();
	...
	/**
	 * Sets the DirectionsResult-object for the vehicle, contains useful information
	 * about the route. Method generally used with BusService - setRouteWaypoints or
	 * setRouteWaypointsOnDemand.
	 * 
